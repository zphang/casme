...
parser.add_argument('--infiller-model', default="ciGAN", type=str, help='etc')
    ...
    for epoch in range(args.epochs):
        ...
        with open(args.log_path, 'a') as f:
            ...
            '''
                    ...
                    tr_s['tv'] + ' ' + val_s['tv'] + '\n')
            '''
        print(str(epoch + 1) + ' ' + str(time.time() - epoch_start_time) + ' ' + '\n')
